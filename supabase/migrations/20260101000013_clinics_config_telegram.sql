-- Extend clinics_config (3.10) with the clinic's Telegram bot token so n8n
-- can identify the clinic from the bot token in the webhook path, and know
-- whether Telegram is enabled for reminder/rating fan-out.
